    ...
    <section className="main3">
      ...
      <div className="main3Contents">
        <div className="contentBox1">
          <img src="/img/innerMain.jpeg" alt="센터 입구" />
          <h4>지역아동센터 입구</h4>
          <p>넓은 입구와 게시판을 두어 한눈에 살펴볼 수 있는 공간</p>
        </div>
        <div className="contentBox2">
          <img src="/img/innerMain2.jpeg" alt="센터 내부1" />
          <h4>지역아동센터 내부(1)</h4>
          <p>
      ...
      <div className="main3Contents">
        <div className="contentBox1">
          <img src="/img/innerMain3.jpeg" alt="센터 내부2" />
          <h4>지역아동센터 내부(2)</h4>
          <p>전체적으로 깔끔한 화이트와 그린톤 컬러로 안정감을 줍니다.</p>
        </div>
        <div className="contentBox2">
          <img src="/img/innerMain4.jpeg" alt="센터 내부3" />
          <h4>지역아동센터 내부(3)</h4>
      ...
      <div className="main3Contents">
        <div className="contentBox1">
          <img src="/img/innerMain5.jpeg" alt="활동실1" />
          <h4>집단활동실(1)</h4>
          <p>보드 게임, 블록, 수 놀이 등을 할 수 있는 활동실</p>
        </div>
        <div className="contentBox2">
          <img src="/img/innerMain6.jpeg" alt="활동실2" />
          <h4>집단활동실(2)</h4>
      ...
      <div className="main3Contents">
        <div className="contentBox1">
          <img src="/img/innerMain7.jpeg" alt="활동실3" />
          <h4>집단활동실(3)</h4>
          <p>드로잉, 접기, 만들기 등 다양한 미술 활동을 할 수 있는 공간</p>
        </div>
        <div className="contentBox2">
          <img src="/img/innerMain8.jpeg" alt="활동실4" />
          <h4>집단활동실(4)</h4>
